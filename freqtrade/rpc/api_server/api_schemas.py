...
class FtPredictionSchema(BaseModel):
    ...
    rank_start: datetime | None = None
    rank_end: datetime | None = None
    rank_ls_rtn: float | None = None
...
class FtPostionSchema(BaseModel):
    ...
    filled_stake_amount: float| None = None
    ...
    refreshed_date: datetime| None = None
    y_pred_scaled: float| None = None
    refreshed_count: int| None = None
    prediction_refreshed_date: datetime| None = None
    latest_close: float| None = None
    latest_high: float| None = None
    latest_low: float| None = None
    trade_id: int| None = None
    trade_side: str| None = None
    trade_leverage: float| None = None
    trade_stake_amount: float| None = None
    trade_value: float| None = None
    unbalance_time: datetime| None = None
    unbalance_state: str| None = None
    warn_state: str| None = None
